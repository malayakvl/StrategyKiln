...
export const getHtmlTableDbTemplate = (data) =>
    `
                ...
                <tr>
                    <td style="vertical-align: middle;">
                        <div style="width: 100%; font-style: normal; font-weight: 300; margin: 0 auto; position: relative;background-color:#fff;">
                            ...
                            <table style="width: 790px;padding: 0; margin: 0;background-color:#fff;">
                                <!-- BORDERED AND SWOT ICONS -->
                                <tr style="display:none;background: #fff;color: #000;">
                                    <td style="background:#fff;height: 30px;padding:0;margin:0;padding:0;">
        ...
        <!--                                <div style="width:1px;background: #ED5829;right: 0;position: absolute; top:-4px;"></div>-->
                        ...
                        "
                                            >
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Part 1: A more externally focused, analytically rigorous "SWOT Fusion Matrix." This is our version of the TOWS Analysis.
                                                </p>
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Part 2: A more externally focused, analytically rigorous "SWOT Fusion Matrix." This is our version of the TOWS Analysis.
                                                </p>
                                    ...
                                    <td style="border-right:solid 1px #FCAB32;border-left:solid 1px #ED5829;"></td>
                                    <td style="position: relative;">
                                        <h2 style="
                                                    font-style: normal;
                                                    font-weight: 600;
                        ...
                        "
                                            >
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    What is the difference between tactics and strategy? What the heck is strategy? Your search is over. Here's Strategy on a page.
                                                </p>
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Map your business state and ride the waves you create into Blue Oceans. Get access to the same Template we used in the Strategy Kiln Shop
                                                </p>
                        ...
                        width: 270px;"
                                                >
                                                    <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                        It takes effort and focus, but the alignment and visibility you’ll get with this one page plan is worth every minute.
                                                    </p>
                            ...
                            "
                                                ><p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Use the G.O.S.T. Template (Goals, Objectives, Strategies, Tactics Template) to get a deeper understanding of strategy.
                                                </p>
                ...
                ">
                                ...
                                <tr>
                                    <td style="position: relative;width:362px;border-right:solid 1px #FCAB32;">
                        ...
                        "
                                            >
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Part 1: We reinvented the SWOT analysis as a story you can tell, rather than a chart you put your coffee cup on.
                                                </p>
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Part 2: We reinvented the SWOT analysis as a story you can tell, rather than a chart you put your coffee cup on.
                                                </p>
                                    ...
                                    <td style="position: relative;width:362px;border-left:solid 1px #ED5829;">
                        ...
                        "
                                            >
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;margin-right: 10px;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    Learn the crucial elements for composing compelling strategy statements that drive focus and clarity.
                                                </p>
                                                <p style="margin-bottom:0;padding-bottom: 0;padding-top:0;font-size: 9px;margin-top:3px;display: block;text-align:left;margin-right: 10px;font-family: 'Inter', Helvetica, Arial, sans-serif">
                                                    It takes effort and focus, but the alignment and visibility you’ll get with this one page plan is worth every minute.
                                                </p>
...
//                                     <td style="background:#fff;height: 30px;padding:0;margin:0;">
//                                         ${strengthsIcon(data.colors)}
//                                         <!-- top border element -->
//                                        
//                                     </td>
//                                     <td style="position: relative">
...
// <!--                                            </tr>-->
// <!--                                        </table>-->
//                                         ${threatsIcon(data.colors)}
//                                     </td>
//                                 </tr>
//                                
//                                 <!-- BEGIN CONTENT -->
//                                 <tr>
//                                     <td style="position: relative;color: #000;z-index: 999;border-right: solid 1px blueviolet;">
//                                         <h2 style="
//                                             font-style: normal;
//                                             font-weight: 600;
//                                             padding-left: 0;
...
//                                     </td>
//                                     <td></td>
//                                     <td style="position: relative;border-left: solid 1px blueviolet;">
//                                         <h2 style="
//                                             font-style: normal;
//                                             font-weight: 600;
//                                             font-size: 14px;
...
//                                 </tr>
//                                 <tr>
//                                     <td style="position: relative;border-right: solid 1px blueviolet;">
//                                         <div style="width:1px;background: #ED5829;right: 0;position: absolute; top:-4px;"></div>
//                                         <div style="margin-left: 24px;">
...
//                                         <div style="width:1px;background: #ED5829;right: 0;position: absolute; top:-4px;"></div>
//                                         <div style="margin-left: 22px;">
//                                             ${weaknesses2StrengthsContent({colorSettings: data.colorSettings, weaknesses2StrengthsData:JSON.parse(data.item.weaknesses2strengths)})}
//                                         </div>
//                                     </td>
//                                     <td></td>
//                                     <td style="position: relative;vertical-align: top;padding-top:17px;">
//                                         <div style="margin-left: 52px;">
//                                             ${threats2OpportunitiesContent({colorSettings: data.colorSettings, threats2OpportunitiesData:JSON.parse(data.item.threats2opportunities)})}
//                                         </div>
//                                     </td>
//                                 </tr>
//                                 <!-- end red block content -->
...
//                                
//                                 <tr>
//                                     <td style="position: relative;width:362px;border-right: solid 1px blueviolet;">
//                                         <div style="margin-left: 24px;color:#000;">
//                                             ${weaknessesContent(JSON.parse(data.item.weaknesses))}
//                                         </div>
//                                     </td>
//                                     <td style="position: relative;"></td>
//                                     <td style="position: relative;width:362px;border-left: solid 1px blueviolet;">
//                                         <div style="margin-left: 52px;color:#000">
...
//                                             </tr>
//                                         </table>
//                                         ${weaknessesIcon(data.colors)}
//                                     </td>
//                                     <td style="position: relative">
//                                         <!-- left border -->
// <!--                                        <div style="width:1px;height:55vh;background: #FCAB32;left: 66px;position: absolute; bottom:30px;" />-->
//                                         <!-- right border -->
// <!--                                        <div style="width:1px;height:55vh;background: #ED5829;right: 66px;position: absolute; bottom:30px;" />-->
//                                     </td>
//                                     <td style="position:relative;background:#fff;height: 30px;padding:0;margin:0;">
//                                         <table cellspacing="0" cellpadding="0" style="border-color: #fff;padding:0; margin: 0;width: 100%;height:30px;border-bottom:0;">
//                                             <tr style="padding:0;margin:0;border-color: #fff;">
